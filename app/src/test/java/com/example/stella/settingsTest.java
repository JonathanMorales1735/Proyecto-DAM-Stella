...
/**
 * Clase para simular la clase "settings" para los test
 */
...
public class settingsTest {
    ...
    public int getCurrentProfileID(){
        settings = context.getSharedPreferences("profileTest", 0);
    ...
    public int getAppTheme(){
        settings = context.getSharedPreferences("generalSettingsTest", 0);
    ...
    public String getLastDailyAction(){
        settings = context.getSharedPreferences("lastDayDailyActionTest", 0);
    ...
    public int getNextTaskID(){
        settings = context.getSharedPreferences("nextIDTest", Context.MODE_PRIVATE);
    ...
    public boolean isFirstRunPassed(){
        settings = context.getSharedPreferences("FIRST_RUNTest", 0 );
    ...
    public boolean isUserActive(){
        SharedPreferences isUserActivePref = context.getSharedPreferences("isUserActiveTest", 0);
    ...
    public void setUserActivity(boolean check){
        settings = context.getSharedPreferences("isUserActiveTest", 0);
        edit = settings.edit();
