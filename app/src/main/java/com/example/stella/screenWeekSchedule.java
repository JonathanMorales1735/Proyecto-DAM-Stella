...
import com.example.stella.recyclerViewsAdapters.listWeeklyTasksAdapter;
...
public class screenWeekSchedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.screen_week_schedule);
