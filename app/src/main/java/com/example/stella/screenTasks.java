...
import com.example.stella.recyclerViewsAdapters.adaptersLogic;
import com.example.stella.recyclerViewsAdapters.listCompletedTasksAdapter;
import com.example.stella.recyclerViewsAdapters.listPendingTasksAdapter;
...
public class screenTasks extends AppCompatActivity {
    ...
    public void showNewTaskScreen(View view){
        Intent intent = new Intent(this, screenNewTask.class);
        startActivity(intent);
    ...
    public void showSummaryScreen(View view){
        ...
        Intent intent = new Intent(this, screenRecords.class);
        startActivity(intent);
    }
    ...
    public void showMyWeekScreen(View view){
        Intent intent = new Intent(this, screenMyWeek.class);
        startActivity(intent);
    }
